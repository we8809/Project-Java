...
public class Program {
	...
	public static void DefaultTest() {
		...
		ReadingList readingList0 = new ReadingList("Summer Break Homework");
		ReadingList readingList1 = new ReadingList("Summer Break Homework");
		readingList0.add(book0);
		readingList0.add(book1);
		readingList0.add(book2);
		readingList0.add(book3);
		assert(readingList0.remove(book3));
		assert(readingList0.remove(book0));
		assert(!readingList0.remove(book0));
	}
