...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        assert(num2.isReal() == true);
        assert(num3.isReal() == false);
        assert(num4.isImaginary() == true);
        assert(num3.isImaginary() == false);
        ...
        System.out.println(String.format("product's real = %f", product.real));
        System.out.println(String.format("product's imaginary = %f", product.imaginary));
        ...
        System.out.println(String.format("quotient's real = %f", quotient.real));
        System.out.println(String.format("quotient's imaginary = %f", quotient.imaginary));
